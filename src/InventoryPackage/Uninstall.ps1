...
# Version 1.6.0. Logs lifecycle; removes only tasks, never retained data or logs.
...
try {
    ...
    if (-not $WhatIfPreference) {
        ...
        Write-InventoryLog -Context $log -Event RunStarted -Data @{ PackageVersion = '1.6.0'; Mode = 'Uninstall' }
    }
    $stage = 'RemoveTasks'
