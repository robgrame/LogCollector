...
# Version 1.0.0. Customer-neutral Intune detection: installed does not mean live ingestion is enabled.
...
if ($config.PackageVersion -ne '1.0.0') { exit 1 }
...
Write-Output "Custom Inventory 1.0.0 installed; SubmissionEnabled=$($config.SubmissionEnabled)."
exit 0
