...
# Version 1.9.1. Resolves shared settings from the protected LogCollector Core configuration.
...
Write-Output "Custom Inventory 1.9.1 installed; CoreSubmissionEnabled=$($coreConfiguration.SubmissionEnabled)."
exit 0
